...
*На данном этапе у вас на руках несколько датафреймоф, один пример построения представления t-SNE и несколько отсылок к другим библиотекам. Прежде чем двигаться дальше в рамках ODS, нужно разобраться как всё это работает.*
