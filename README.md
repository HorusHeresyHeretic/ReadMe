...
*Поскольку несколько человек написали мне и попросили развить тему - выкатываю [вторую часть](https://github.com/HorusHeresyHeretic/Pandas_Practice) гайд в формате ipnynb*.  
